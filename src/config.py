...
model_weights_file_name = output_dir + "multi_digit_model_1_to_8_real_weights.h5"
model_tflite_name = output_dir + "worksheet.multi_digit_model_1_to_8_real.tflite"
