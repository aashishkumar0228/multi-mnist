...
def main(output_dir):
    train_folder_path = "/Users/aashishkumar/Documents/Projects/forked_repos/multi-mnist/zone_classifier_data/train_5"
    num_classes = 3
    img_height = 28
    shuffle = True
    ...
    history_1 = model.fit(train_multi_digit_dataset, epochs=epochs, callbacks=[lrr])
    ...
    # prefix = "lstm_attempt_6"
    # base_folder = "/Users/aashishkumar/Documents/Projects/forked_repos/multi-mnist/zone_classifier_model/"
    # base_folder_name = base_folder + prefix + "/"
    # if not os.path.isdir(base_folder_name):
    #     os.mkdir(base_folder_name)
    # model_tflite_name = base_folder_name + "worksheet.multi_digit_zone_clf_" + prefix + ".tflite"
    # model_folder_name = base_folder_name + "multi_digits_zone_classifier"
    # model_json_file_name = base_folder_name + "multi_digits_zone_classifier_json.json"
    # model_weights_file_name = base_folder_name + "multi_digits_zone_classifier_weights.h5"

    model_tflite_name = os.path.join(output_dir, "worksheet.multi_digit_zone_clf.tflite")
