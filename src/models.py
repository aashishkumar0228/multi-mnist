...
def build_big_transformer_ocr_model(img_height, num_classes=11):
    # Inputs to the model
    input_img = layers.Input(shape=(None, img_height, 1), name="image", dtype="float32")
    labels = layers.Input(name="label", shape=(None,), dtype="float32")
    ...
    transformer_block_2 = TransformerBlock(num_heads=2, key_dim=128, ff_dim=128, maximum_position_encoding=80, name='tansformer_block_2')
    x = transformer_block_2(x)
    transformer_block_3 = TransformerBlock(num_heads=2, key_dim=128, ff_dim=128, maximum_position_encoding=80, name='tansformer_block_3')
    x = transformer_block_3(x)
    transformer_block_4 = TransformerBlock(num_heads=2, key_dim=128, ff_dim=128, maximum_position_encoding=80, name='tansformer_block_4')
