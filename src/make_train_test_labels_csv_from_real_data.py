...
train_folder = "/Users/aashishkumar/Documents/Projects/forked_repos/multi-mnist/real_data_hw/test"
...
data_path = "/Users/aashishkumar/Documents/Projects/vision/training_database/worksheet_zone/recognize_multi_digits/regression/"
list_subfolders_with_paths = []
for f in os.scandir(data_path):
    if f.is_dir():
        if f.name == "-3" or f.name == "-2" or f.name == "-1":
            continue
